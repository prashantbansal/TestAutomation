...
public class ResumeSuspendQuiz 
{
	...
	{
		System.out.println("****** V1 Resume Suspend Quiz Start ********");
		try 
		{
			if (DPLValues != null) {
...
//			assertTrue(utils.selenium.isTextPresent("For Customer Service"));
			...
			utils.selenium.waitForElementPresent("ctl00_ContentPlaceHolder1_ctl00_GridView1_ctl02_LinkButton3");

			utils.selenium.click("ctl00_ContentPlaceHolder1_ctl00_GridView1_ctl02_LinkButton3");
			utils.selenium.isElementPresent("ctl00_ContentPlaceHolder1_Suspend_LinkBut_Img");
		...
		System.out.println("****** V1 Resume Suspend Quiz End ********");
