...
public class SubmitQuiz 
{
	...
	{
		System.out.println("****** V1 QBank - Submit Quiz Start ********");
		try 
		{
			if (DPLValues != null) {
			...
			utils.selenium.click("ctl00_ContentPlaceHolder1_Template_AOptions_ra_v|0");
			utils.selenium.click("ctl00_ContentPlaceHolder1_Next_LinkBut_Img");
			utils.selenium.assertEquals("This is the last question. Click \"OK\" to end the quiz. Click \"Cancel\" to submit the quiz later.", utils.selenium.getConfirmation());
		...
		System.out.println("****** V1 QBank - Submit Quiz End ********");
	}
