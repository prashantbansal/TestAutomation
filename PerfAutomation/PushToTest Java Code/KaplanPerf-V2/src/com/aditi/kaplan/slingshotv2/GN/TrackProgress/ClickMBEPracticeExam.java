 ...
 *
 */
public class ClickMBEPracticeExam 
{
	Utils utils = null;
	...
	{
		System.out.println("****** V2 GN.TrackProgress - ClickMBEPracticeExam Start ********");
		try
		{
		...
		{
			System.out.println("****** ClickMBEPracticeExam Failed ******");
            utils.selenium.saveSource("ClickMBEPracticeExam-report-failed.html");
            throw ex;
		}
		
		System.out.println("****** V2 GN.TrackProgress - ClickMBEPracticeExam End ********");
