...
/***
 * This class is used to test Submit Quiz functionality of Global Navigation.
 * @author Aditi
 *
 */
public class SubmitGNQuiz 
{
	Utils utils = null;
	...
	{
		System.out.println("****** V2 Submit Quiz - Start ********");
		try
		{
            if (DPLValues != null) {
		...
		{
			System.out.println("****** SubmitGNQuiz Failed ******");
            utils.selenium.saveSource("SubmitGNQuiz-report-failed.html");
            throw ex;
		}
		
		System.out.println("****** V2 Submit Quiz -  End ********");
