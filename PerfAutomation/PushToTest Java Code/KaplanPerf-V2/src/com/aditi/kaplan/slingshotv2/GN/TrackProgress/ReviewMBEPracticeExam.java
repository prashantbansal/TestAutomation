 ...
 *
 */
public class ReviewMBEPracticeExam 
{
	Utils utils = null;
	...
	{
		System.out.println("****** V2 GN.TrackProgress - ReviewMBEPracticeExam Start ********");
		try
		{
	         if (DPLValues != null) {
				...
				utils.selenium.waitForElementPresent("ctl00_ContentPlaceHolder1_ucTestProgressStateFinalExam_ctl00_HyperLink_TakeTest");
				utils.selenium.click("ctl00_ContentPlaceHolder1_ucTestProgressStateFinalExam_ctl00_HyperLink_TakeTest");
				utils.selenium.waitForPageToLoad("45000");
				...
				utils.selenium.click("ctl00_ContentPlaceHolder1_lbtnReview_Img");
		...
		{
			System.out.println("****** ReviewMBEPracticeExam Failed ******");
            utils.selenium.saveSource("ReviewMBEPracticeExam-report-failed.html");
            throw ex;
		}
		
		System.out.println("****** V2 GN.TrackProgress - ReviewMBEPracticeExam End ********");
